  ...
  var gmeResources = {
  	...
  	html: {
  		config: '<section class="gme-tab">\
  				...
  				<label class="gme-tab-label" for="gme-tab-maps">Mapy</label>\
  				<div class="gme-tab-content">\
  					<div class="gme-fieldgroup">\
  						<h3>Zobrazení map ve widgetu</h3>\
  						<ul id="GME_mapfields"></ul>\
  						<label>Výchozí zdroj: &nbsp;<select name="GME_map_default" id="GME_map_default"></select></label>\
  					</div>\
  				</div>\
  			</section>\
  			<section class="gme-tab">\
  				<input type="radio" name="gme-tab-row" id="gme-tab-manage" />\
  				<label class="gme-tab-label" for="gme-tab-manage">Upravit mapy</label>\
  				<div class="gme-tab-content">\
  					<div class="gme-fieldgroup">\
  						<h3>Přidat mapové podklady</h3>\
  						<label>Zdroj map: <input type="text" name="GME_map_custom" id="GME_map_custom">&nbsp;</label>\
  						<div class="leaflet-control-gme"><button type="button" id="GME_custom_add" class="gme-button gme-button-wide gme-button-l gme-button-r" title="přidat zdroj">přidat</button> <a href="#GME_format" title="Map source format info" class="gme-button gme-button-wide gme-button-l">informace o formátu map</a><button type="button" id="GME_custom_export" title="Export custom map source JSON" class="gme-button gme-button-wide gme-button-r">exportovat vlastní mapy</button></div>\
  					</div>\
  					<div class="gme-fieldgroup">\
  						<h3>odstranit mapové podklady</h3>\
  			...
  			<section class="gme-tab">\
  				...
  				<label class="gme-tab-label" for="gme-tab-other">Jiné</label>\
  				<div class="gme-tab-content">\
  					<div class="gme-fieldgroup">\
  						<h3>Různá nastavení</h3>\
  						<ul>\
  							<li><label title="Only list unfound caches in search"><input type="checkbox" name="GME_filterFinds" id="GME_filterFinds" /> filtrovat hledání</label></li>\
  							<li><label><input type="checkbox" checked="checked" name="GME_osgbSearch" id="GME_osgbSearch" /> rozšířené hledání</label></li>\
  							<li><label title="Location widget constantly updates position"><input type="checkbox" name="GME_follow" id="GME_follow" /> mód následuj mě</label></li>\
  						</ul>\
  						<label>Titulky:\
  							<select name="GME_labelStyle" id="GME_labelStyle">\
  								<option value="names">jména</option>\
  			...
  			<section class="gme-tab">\
  				...
  				<label class="gme-tab-label" for="gme-tab-about">o GME<strong>CZ</strong></label>\
  				<div class="gme-tab-content">\
  					<div class="gme-fieldgroup">\
                         <h3>GME<strong>CZ</strong> - český Geocaching Map Enhancements</h3><br />\
  			...
  			<div class="leaflet-control-gme">\
  				<button type="button" class="gme-button gme-button-wide gme-button-l" id="GME_set" title="uložit nastavení">💾&nbsp;uložit</button><button href="#" class="gme-button gme-button-wide" rel="back" title="storno">❌&nbsp;storno</button><button type="button" class="gme-button gme-button-wide gme-button-r" id="GME_default" title="Nastavit výchozí hodnoty">⭕&nbsp;výchozí</button>\
  			</div>',
  		customInfo: '<p>Vlastní zdroje map lze přidat zadáním <a rel="external" href="http://www.json.org/">JSON</a> konfigurační řetězec, který říká GME, jak má mapu nazývat, kde ji najít a jak je nastavena. např.</p>\
...
<p>Parametry <code>"alt"</code> a <code>"tileUrl"</code><span tabindex="-1" lang="cs"><span title="">jsou povinné</span></span>. <code>"tileUrl"</code> <span tabindex="-1" lang="cs"><span title="">může obsahovat</span></span> {x}, {y} a {z} ze <span tabindex="-1" lang="cs"><span title="">souřadnicového systému Google</span></span> (<span tabindex="-1" lang="cs"><span title="">také pracuje s</span></span> TMS systémem jako Eniro, ale potřebuje parametr <code>"scheme":"tms"</code>), nebo {q} pro Bing. <span lang="cs"><span title="">GME se také může spojit se servery WMS, v takovém případě je vyžadován parametr</span></span> <code>"layers"</code></p>\
<p><span lang="cs"><span title="">Ostatní parametry jsou stejné jako ty, které používá rozhraní <a rel="external" href="http://leafletjs.com/reference-versions.html">Leaflet API</a>,  s přidáním možnosti<code> "overlay":true</code>, díky níž se zdroj map zobrazí jako volitelné překrytí.</span></span></p>\
<ul><li><a rel="external" href="http://geo.inge.org.uk/gme_config.htm">podrobnější dokumentace k mapám</a> - originální v ENG</li><li><a rel="external" href="http://geo.inge.org.uk/gme_maps.htm">více mapových příkladů</a> - originální v ENG</li><li><a rel="external" href="https://gmecz.geosever.cz">mapové podklady</a> - české, slovenské a další</li></ul>',
  		search: '<input type="text" placeholder="Adresa, souřadnice, GC kód, klíčové slovo atd." id="SearchBox_Text" title="Přejít na konkrétní úroveň zvětšení zadáním zvětšení a poté čísla. Zoom 1 ukazuje celý svět, maximální zvětšení je obvykle 18-22." />\
  			<button id="SearchBox_OS" title="Search">Hledání</button>\
  			<div class="GME_search_results hidden">\
  				...
  				<p>nebo zkusit <a href="#" class="GME_link_GSSearch">Geocaching.com vyhledávání</a>\
  			</div>'
  	},
  	script: {
  		common: function () {
  				...
  				var initScripts = {
  					"config": function () {
  						if (gmeConfig.env.storage) {
  							...
  							$("li.li-user ul").append("<li class='li-settings'><a class='icon-settings' id='gme-config-link' href='#GME_config' title='Nakonfigurujte rozšíření GMECZ'>GMECZ</a></li>");
  						}
  					},
  					"drop": function () {
  				...
  				document.addEventListener("GME_XHR_callback", function (e) {
  					...
  					if (typeof window[callback] === "function") {
  						try {
  							...
  							console.error("Při zpracování zpětného volání JSON došlo k chybě " + callback + ": " + e);
  						}
  					} else {
  						console.warn("Neočekávaný požadavek na obsluhu zpětného volání JSON: Nelze najít funkci zpětného volání " + callback);
  					}
  					return false;
  				});
  			} else {
  				JSONP = function (url, id) {
  					console.log("GMECZ: používám JSONP k odchycení " + url);
  					if (validURL(url)) {
  			...
  			this.getGeograph = function(coords) {
  				...
  				function makeCallback(callname) { callbackCount++; return function(json) {
  					...
  					if (json.items && json.items.length>0) {
  						html = ["<h3>Geografické snímky poblíž ", DMM(coords), "</h3><p>"].join("");
  						...
  						html += ["</p><p><a target='_blank' rel='noopener noreferrer' href='",searchLink(coords),"'>Vyhledat další fotografie v okolí na Geograph</a></p><p style='font-size:90%;'>Geograph fotografie jsou chráněny autorskými právy jejich vlastníků a jsou k dispozici pod  <a href='https://creativecommons.org/licenses/by-sa/2.0/'>Creative Commons licencí</a>. Podržením myši nad miniaturami zobrazíte další podrobnosti nebo kliknutím zobrazíte úplné obrázky.</p>"].join("");
  						$.fancybox(html);
  					} else {
  						$.fancybox(["<p>V okolí nebyly nalezeny žádné fotografie. <a target='_blank' rel='noopener noreferrer' href='",searchLink(coords),"'>hledat na Geograph</a></p>"].join(""));
  					}
  					$("#"+callname).remove();
  				...
  				if (validCoords(coords) && this.isGeographAvailable(coords)) {
  					...
  					console.error("GMECZ: Špatné souřadnice pro getGeograph");
  				}
  			};
  			this.getHeight = function(coords) {
  				...
  				function makeCallback(callname) { callbackCount++; return function (json) {
  					if (typeof json.astergdem === "number" && typeof json.lat === "number" && typeof json.lng === "number") {
  						...
  						if (json.astergdem === -9999) {
  							m = "<p><strong>Nadmořská výška</strong><br/>hladina moře</p>";
  						} else {
  							h = that.parameters.measure==="metric"?json.astergdem+" m":Math.round(json.astergdem*3.2808)+" ft";
  							m = ["<p><strong>Nadmořská výška</strong><br/>Cca ",h," m n.m.</p>"].join("");
  						}
  						$.fancybox(m);
  					}
  					$("#"+callname).remove();
  				...
  				if (validCoords(coords)) {
  					...
  					console.error("GMECZ: Špatné souřadnice pro getHeight");
  				}
  			};
  			...
  			if (gmeConfig.env.geolocation) {
  				this.seekHere = function() {
  					...
  					function hereError(err) {
  						if (err.code === 2) {
  							alert("Aktuální poloha není k dispozici");
  						}
  						if (err.code === 3) {
  							alert("Časový limit hledání aktuální polohy vypršel");
  						}
  						$("#GME_hereSub").val("Go");
  					}
  					$("#GME_hereSub").val("Čekání na umístění...");
  			...
  			this.seekByLatLng = function(latlng) {
  				if (validCoords(latlng)) {
  					...
  					console.error("GMECZ: Neplatné souřadnice pro vyhledávání");
  				}
  			};
  		},
  		config: function () {
  		...
  		dist: function () {
  			$("#lblDistFromHome").parent().append("<br/><span id='gme-dist'><a href='#' id='gme-dist-link'>Zkontroluj vzdálenost odsud</a></span>");
  			$("#gme-dist-link").click(function () {
  				...
  				function found(pos) {
  					...
  					$("#gme-dist").html("<img style='vertical-align:text-bottom' alt='" + dir + "' src='/images/icons/compass/" + dir + ".gif'> " + dir + " " + formatDistance(here.distanceTo(there)*1000) + " odtud ve směru " + Math.round(bearing) + "&deg;");
  				}
  				function lost() {
  					if (watcher) {
  						navigator.geolocation.clearWatch(watcher);
  					}
  					alert("GMECZ nemohlo zjistit vaši polohu.\nPokud se tato chyba objeví opakovaně, deaktivujte režim následování");
  				}
  		...
  		drag: function () {
  			that.dragStart = function (event) {
  				...
  				function GME_formatLOC_wpt(id, desc, coords, type, link) {
  					if (id && desc && coords) {
  						...
  						switch(type) {
  							...
  							case 218: t="Otázka k odpovědi"; break;
  							case 219: t="Stage multicache"; break;
  							case 220: t="Konečné umístění"; break;
  							case 221: t="Rozcestník"; break;
  							case 452: t="Referenční bod"; break;
  						}
  						return ('<waypoint>\n\t<name id="' + id + '"><![CDATA[' + desc + ']]></name>\n\t<coord lat="' + coords.lat + '" lon="' + coords.lng + '"/>\n\t<type>' + t + '</type>' + l + '\n</waypoint>');
  					}
  					console.warn("GMECZ: Chybí data cache - id:", id , "desc:", desc, "coords:", coords);
  					return null;
  				}
  				var c, dataURI, dt, i, locfmt,
  					id = $("#ctl00_ContentBody_CoordInfoLinkControl1_uxCoordInfoCode")[0].innerHTML,
  					loc = [GME_formatLOC_wpt(id, cache_coords.primary[0].name, cache_coords.primary[0], cache_coords.primary[0].type,{desc:"Detaily cache",href:"https://coord.info/"+id})];
  				...
  				if (cache_coords.primary[0].isUserDefined) {
  					loc.push(GME_formatLOC_wpt("GO"+id.slice(2), cache_coords.primary[0].name, {lat:cache_coords.primary[0].oldLatLng[0], lng:cache_coords.primary[0].oldLatLng[1]}, "Původní souřadnice",{desc:"Detaily cache",href:"https://coord.info/"+id}));
  				}
          ...
          $("head").append("<link rel='preconnect' href='https://fonts.gstatic.com'><link href='https://fonts.googleapis.com/css2?family=Inter&display=swap' rel='stylesheet'>");
  		...
  		widget: function () {
  			...
  			widgetControlObj = {
  				...
  				onAdd:function(contextmap){
					...
					html = "<button type='button' class=\'GME_info gme-button gme-button\' title=\'Použít informace o souřadnicích\' data-gme-action=\'toggleInfo\'></button>";
					html += "<button type='button' class=\'GME_hide gme-button\' title=\'Skrýt cache\' data-gme-action=\'toggleCaches\'></button>";
					html += "<button type='button' class=\'GME_route gme-button\' title=\'Otevřít měření cesty\' data-gme-action=\'toggleRoute\'></button>";
					if (gmeConfig.env.home) {
						html += "<button type='button' title=\'Na domácí souřadnice\' class=\'GME_home gme-button\' data-gme-action=\'panToHome\'></button>";
					}
					if (gmeConfig.parameters.osgbSearch) {
          ...
          html += "<a class=\'GME_GS gme-button\' title=\'navštívit web GeoSever - domov drsnoseverských kačerů\' href=\'https://www.geosever.cz/' target='blank'></a>";
					container.innerHTML = html;
					$(container.lastChild).addClass("gme-button");
					container.innerHTML += "<span class=\'gme-button gme-scale-container\' title=\'Přibližná šířka celého zobrazení mapy\' style=\'cursor:help;\'><img src='https://gmecz.geosever.cz/scale.png' width='18px' /><span class=\'gme-scale\'>-</span></span><span class=\'gme-distance-container gme-button gme-button-r\' title=\'Měřená vzdálenost\'>cesta: <span class=\'gme-distance\'>"+ formatDistance(0) +"</span></span>";
				...
				clearDist:function () {
					...
					$(".gme-scale-container").addClass("gme-button");
				},
				...
				dropDist:function(ll) {
					...
					if (this._dist_line === undefined) {
						...
						$(this._map._container).find(".gme-scale-container").removeClass("gme-button");
					} else {
				...
				toggleCaches:function() {
					if (window.MapSettings && MapSettings.MapLayers && MapSettings.MapLayers.AddGeocacheLayer && MapSettings.MapLayers.RemoveGeocacheLayer) {
						if (MapSettings.MapLayers.Geocache) {
							...
							$(".GME_hide").addClass("gme-button-active").attr("title","Zobrazit cache");
						} else {
							MapSettings.MapLayers.AddGeocacheLayer();
							$(".GME_hide").removeClass("gme-button-active").attr("title","Skrýt cache");
						}
					}
				},
					...
					var that = this, widgets = {
						info: {
							on: function() {
								...
								$(".GME_info").addClass("gme-button-active").attr("title","Zavřít informace o lokaci");
							},
							off: function() {
								that._map.off("click contextmenu",that.showInfo,that);
								$("#map_canvas").removeClass("gme-xhair");
								$(".GME_info").removeClass("gme-button-active").attr("title","Povolit informace o lokaci");
							}
						},
						...
						route: {
							on: function() {
								...
								$("#map_canvas").addClass("gme-xhair");
								$(".GME_route").addClass("gme-button-active").attr("title","Zavřít routovací nástroj");
							},
							off: function() {
								that._map.off("click contextmenu",that.showRoute,that);
								$("#map_canvas").removeClass("gme-xhair");
								$(".GME_route").removeClass("gme-button-active").attr("title","Povolit routovací nástroj");
							}
						}
					};
					if (!widgets[mode]) {
